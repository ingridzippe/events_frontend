...
import { DeviceInfo, Dimensions, InteractionManager, NativeModules, Platform, SafeAreaView, View } from 'react-native';
...
class SafeView extends Component {
  ...
  render() {
    ...
    return <View ref={c => this.view = c} onLayout={this._onLayout} style={[style, safeAreaStyle]}>
        {this.props.children}
      </View>;
  }
